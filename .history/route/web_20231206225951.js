...
//clinic
   ...
   //doctor
    ...
    router.post('/api/save-schedule-doctors', doctorController.postScheduleDoctor);
    ...
    router.get('/api/sear-all-booking-for-admin', adminController.searAllBookingForAdmin);
